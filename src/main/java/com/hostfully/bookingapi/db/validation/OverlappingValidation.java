...
public class OverlappingValidation {
    ...
    public void checkOverlappingPeriod(Long propertyId, Period period) {
        checkOverlappingBlocking(propertyId, period);
        checkOverlappingBooking(propertyId, period);
    }

    private void checkOverlappingBlocking(Long propertyId, Period period) {
    ...
    private void checkOverlappingBooking(Long propertyId, Period period) {
    ...
    public void checkOverlappingPeriod(Long id, Long propertyId, Period period) {
        checkOverlappingBlocking(id, propertyId, period);
        checkOverlappingBooking(id, propertyId, period);
    }

    private void checkOverlappingBlocking(Long id, Long propertyId, Period period) {
        int overlappingBlockingsCount = blockingRepository.checkOverlapping(id, propertyId, period);

        checkOverlappingCount(overlappingBlockingsCount, "This Property is already blocked in this period!");
    }

    private void checkOverlappingBooking(Long id, Long propertyId, Period period) {
